...
--Insertar información en la tabla Cliente
insert into Cliente
...
insert into Cliente
values('Misael Adame', 'Calle 21A', 'Gomez Palacio')
...
--Insertar información en la tabla Cuenta
insert into Cuenta
values(24598, 'Tláloc', 40000)
...
--Insertar información en la tabla Prestamo
...
insert into Prestamo
values(893243, 'Tláloc', 330000)

insert into Prestamo
values(412444, 'Tláloc', 90000)

insert into Prestamo
values(8999, 'Angelo', 500000)

--Insertar información en la tabla Cliente_Cuenta
...
--C9: Información de los prestamos ordenada por importe de forma descendente 
...
--C18: Agregue el atributo teléfono a los clientes
alter table Cliente
add Telefono int
...
--C21: Cambiar la ciudad de los clientes cuyo nombre inicie con 'A', para que sea Torreón
Update Cliente
set Ciudad_Cliente = 'Torreon'
where Nombre_Cliente = 'A%'

--C22: Mostrar la información de los prestamos de los clientes que viven en Gomez 
select * from Prestamo
...
--C25: Calle, Nombre y ciudad del Cliente que más debe
...
--C28: Aumente un 10% de interés a los prestamos de la Sucursal Centro
Update Prestamo 
...
Insert into Cliente
values('Alfaro', 'San Antonio', 'Gomez Palacio', '871233454')
